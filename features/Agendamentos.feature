Feature: Agendamentos
    ...
    Cenário: Novo Agendamento com Sucesso
        ...
        And: O horário de “12:00” no dia “26/04” está livre.
        ...
        And: O agendamento realizado para o negócio “X” para “4 pessoas” no horário de “12:00” no dia “26/04” pode ser visto na lista de Meus Agendamentos.

    Cenário: Novo Agendamento com Falha
        Given: Eu estou na página de Agendamento do negócio “X”
        And: O horário de “12:00” no dia “26/04” já foi preenchido.
        When: Eu faço uma reserva para “4 pessoas” no horário de “12:00” no dia “26/04”.
    ...
    Cenário: Cancelar agendamento
        ...
        And: Eu estou na página de Meus Agendamentos.
        ...
        And: A lista de Meus Agendamentos está vazia.

    Cenário: Pesquisar Agendamentos por negócios
        Given: Existe um agendamento para o negócio “X” para o horário de “12:00” no dia “26/04”.
        And: Existe um agendamento para o negócio “Y” para o horário de “17:00” no dia “21/04”.
        And: Eu estou na página de Meus Agendamentos.
